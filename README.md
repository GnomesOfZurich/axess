...
> **Status:** `v0.5.0` on crates.io. The 0.x line is pre-1.0; the public
...
```toml
[dependencies]
axess = { version = "0.5.0", features = ["sqlite", "authz", "testing"] }
axum = "0.8"
...
```toml
[dependencies]
axess = { version = "0.5.0", features = ["sqlite", "authz"] }
```
