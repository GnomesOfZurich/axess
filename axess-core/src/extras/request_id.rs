...
/// # Alternative
///
/// For most applications, [`tower_http::request_id`](https://docs.rs/tower-http/latest/tower_http/request_id/)
/// provides `SetRequestId` + `PropagateRequestId` with the same functionality.
/// This Axess implementation adds the `accept_client_id` feature for validating
/// and preserving client-provided request IDs, which `tower-http` does not offer.
